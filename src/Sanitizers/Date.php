<?php
    ...
    class Date extends Sanitizer {
         ...
         * @throws \Exception
         */
        protected function readDate(string $value) : ?\DateTime {
            ...
            if (null !== $this->timeZone) {
                ...
                $date = \DateTime::createFromFormat($this->readFormat, $value, $this->timeZone);
            } else {
